...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan  7 20:06:43 2020
...
USMacrodata = pd.read_csv('/Data/USMacrodata.csv')
EUMacrodata = pd.read_csv('/Data/EUMacrodata.csv')
UKMacrodata = pd.read_csv('/Data/UKMacrodata.csv')
#IndMacrodata = pd.read_csv('/Data/IndiaMacrodata_.csv')
#ChinaMacrodata = pd.read_csv('/Data/ChinaMacrodata.csv')
# Asset data
...
FTSEdata = pd.read_csv('/Data/FTSE100.csv')
Daxdata = pd.read_csv('/Data/Dax.csv')
# Sensexdata = pd.read_csv('/Data/Sensex.csv')
# Shanghaidata = pd.read_csv('/Data/ShanghaiComposite.csv')
...
WilshireREdata = pd.read_csv('/Data/WilshireREPriceIndex.csv')
US10YrYielddata = pd.read_csv('/Data/US10YrYield.csv')
UK10YrYielddata = pd.read_csv('/Data/UK10YrYield.csv')
EUBund10YrYielddata = pd.read_csv('/Data/German10YrYield.csv')
#India10YrYielddata = pd.read_csv('/Data/India10YrYield.csv')
#China10YrYielddata = pd.read_csv('/Data/China10YrYield.csv')
UST10YrPriceddata = pd.read_csv('/Data/UST10YrPrice.csv')
UKGilt10YrPricedata = pd.read_csv('/Data/UKGilt10YrPrice.csv')
EUBund10YrPricedata = pd.read_csv('/Data/EUBund10YrPrice.csv')
FedForecastdata = pd.read_csv('/Data/FedForecasts.csv')
EUForecastdata = pd.read_csv('/Data/ECBForecasts.csv')
BoEForecastdata = pd.read_csv('/Data/BoEForecasts.csv')
PortfolioWeights = pd.read_csv('/Data/PortfolioWeights.csv')
...
plt.figure()
assetcrctdiryr.plot.bar(subplots=True, figsize=(10,10), legend=False, title='Act vs Pred Same Direction Year Total')
plt.xlabel('Year. 0-2000, 19-2019')
plt.ylabel('Total out of 12')
plt.show()
cmdcrctdiryr.plot.bar(subplots=True, figsize=(10,10), legend=False, title='Act vs Pred Same Direction Year Total')
plt.xlabel('Year. 0-2000, 19-2019')
plt.ylabel('Total out of 12')
plt.show()
bondcrctdiryr.plot.bar(subplots=True, figsize=(10,10), legend=False, title='Act vs Pred Same Direction Year Total')
plt.xlabel('Year. 0-2000, 19-2019')
plt.ylabel('Total out of 12')
plt.show()
...
plt.figure()
assetcrctdirmthpct.plot.bar(subplots=True, figsize=(10,10), legend=False, title='Act vs Pred Same Month All Years Total %')
plt.xlabel('Month. 0-January, 11-December')
plt.ylabel('Total % out of 20 years')
plt.show()
cmdcrctdirmthpct.plot.bar(subplots=True, figsize=(10,10), legend=False, title='Act vs Pred Same Month All Years Total %')
plt.xlabel('Month. 0-January, 11-December')
plt.ylabel('Total % out of 20 years')
plt.show()
bondcrctdirmthpct.plot.bar(subplots=True, figsize=(10,10), legend=False, title='Act vs Pred Same Month All Years Total %')
plt.xlabel('Month. 0-January, 11-December')
plt.ylabel('Total % out of 20 years')
plt.show()
...
print('\n FrcstPred Portfolio Weighted Return: ',FrcstPredPortfolioReturn*1000)
...
print('\n FrcstPred Portfolio Annualized Return: ',frcstpredportfannlzdreturnval*100)
...
print('\n  FrcstPredPortfolio Average Return: ',frcstpredportfavgreturnval*100)
